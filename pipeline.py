...
LUA_SHA1 = get_hash(os.path.join(CWD, 'fc2.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'url':
                wget_args.extend(['--warc-header', 'fc2-url: '+item_value])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/f/fd/Fc2-icon.png/542px-Fc2-icon.png" height="50px" title=""/>
        <h2>FC2 <span class="links"><a href="https://fc2.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/fc2/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/FC2">Wiki</a></span></h2>
        <p>Archiving FC2.</p>
    '''
)
