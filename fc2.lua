...
wget.callbacks.get_urls = function(file, url, is_css, iri)
  ...
  if allowed(url)
    ...
    and not string.match(url, "^https?://diary[0-9]*%.fc2%.com/img/")
    and not string.match(url, "^https?://diary[0-9]*%.fc2%.com/images/")
    and not string.match(url, "^https?://vote[0-9]*%.fc2%.com/images/")
    and not string.match(url, "^https?://pr%.fc2%.com/images?/")
    and not string.match(url, "^https?://bbs%.fc2%.com/img/")
    and not string.match(url, "^https?://analyzer[0-9]*%.fc2%.com/image/")
    and not string.match(url, "^https?://analyzer[0-9]*%.fc2%.com/en/image/")
    and not string.match(url, "^https?://apps%.fc2%.com/assets/")
    and not string.match(url, "^https?://help%.fc2%.com/assets/")
    and not string.match(url, "^https?://chat%.fc2%.com/img/")
    and not string.match(url, "^https?://piyo[0-9]*%.fc2%.com/contents/image/")
    and not string.match(url, "^https?://piyo[0-9]*%.fc2%.com/upfile/")
    and not string.match(url, "^https?://icon%.fc2%.com/img/")
    and not string.match(url, "^https?://icon%.fc2%.com/images/")
    and not string.match(url, "^https?://media[0-9]*%.fc2%.com/")
    and not string.match(url, "^https?://static[0-9]*%.fc2%.com/")
    and not string.match(url, "^https?://static%-game%.fc2%.com/")
    and not string.match(url, "^https?://emoji%.fc2%.com/")
    and not string.match(url, "^https?://k[0-9]*%.fc2%.com/js/")
    and not string.match(url, "^https?://k[0-9]*%.fc2%.com/img/")
    and not string.match(url, "^https?://kbbs[0-9]*%.fc2%.com/clickPICT/")
    and not string.match(url, "^https?://api%.game%.fc2%.com/js/")
    and not string.match(url, "^https?://web%.fc2%.com/[^/]+/fc2img/")
    and not string.match(url, "^https?://web%.fc2%.com/fc2img/")
    and not string.match(url, "^https?://[^/]*fc2web%.com/[a-z]+%-image/")
    and not string.match(url, "^https?://static%-id[0-9]*%.fc2%.com/")
    and not string.match(url, "^https?://cnt%.fc2%.com/")
    and not string.match(url, "^https?://storage[0-9]*%.contents%.fc2%.com/")
    and not string.match(url, "^https?://blog%-imgs?%-?[0-9]*[^/]*%.fc2%.com/")
